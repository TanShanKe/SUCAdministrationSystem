...
$sql2 = "SELECT MAX(YEAR(applicationDate)) AS latestYear, CASE WHEN MONTH(MAX(applicationDate)) BETWEEN 3 AND 5 THEN 1 WHEN MONTH(MAX(applicationDate)) BETWEEN 6 AND 9 THEN 2 WHEN MONTH(MAX(applicationDate)) BETWEEN 10 AND 12 THEN 3 WHEN MONTH(MAX(applicationDate)) BETWEEN 1 AND 2 THEN 4 ELSE 1 END AS latestSem FROM change_class_record";
...
<div class="container-fluid" style="width: 90%;" >
    ...
    <table class="table "> 
        ...
        if ($selectedSem == 1) {
          ...
          $endMonth = 2;   // February
          $sql = "SELECT changeClassID, applicationDate, lecturer.name AS applicantName, aaroAcknowledge, aaroSignature, deanOrHeadAcknowledge, deanOrHeadSignature FROM change_class_record LEFT JOIN lecturer ON change_class_record.applicantID=lecturer.lecturerID 
          WHERE 
